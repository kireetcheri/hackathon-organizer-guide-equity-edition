...
|---------|---------------|
| [Zero-Budget Guide](zero-budget/README.md) | Running a hackathon with $0 from your school |
| [Grant Sources](zero-budget/grant-sources.md) | Specific programs that fund student hackathons |
| [HackClub Bank](zero-budget/hackclub-bank.md) | The fastest path to $500 and fiscal sponsorship |
| [Admin Buy-In](../Organizer-Resources/getting-support-from-others/working-with-organisations-and-school-administration.md) | Getting your school to say yes |
| [Cold-Start Sponsor Outreach](sponsors/cold-start-outreach.md) | Finding sponsors when you know nobody |
| [Judging Rubric](judging/rubric.md) | Scoring criteria your judges can actually use |
...
The MLH guide is excellent on #5 (marketing) and parts of #4. This pack fills in #1, #2, and #3.

---

*Based on the [MLH Hackathon Organizer Guide](https://github.com/MLH/mlh-hackathon-organizer-guide) (CC BY 4.0) with additions for equity and access.*
